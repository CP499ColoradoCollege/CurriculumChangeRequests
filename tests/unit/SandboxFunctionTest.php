<?php 
class SandboxFunctionTest extends \Codeception\Test\Unit
{
    /**
     * @var \UnitTester
     */
	...
	public function testFunctions(){
		...
		//first will test contains, which takes in an array and a value and returns true if array contains the value
		$test_array = array(1, 2, 6, 4, 5);
		$this->assertTrue(contains(2, $test_array));
